...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 20, 2017 at 02:55 PM
...
INSERT INTO `tbl_school` (`school_master_id`, `school_id`, `teacher_stud_ratio`, `student_count`, `school_timing`, `classes`, `establish_in`, `image`) VALUES
(30, 32, '23:44', 454, '12:30am - 1:00am(nursery)', '5-12', '1999', 'webdesk_logo.jpg'),
(31, 33, '23:44', 454, '1:00am - 2:00am(nursery)', '5-12', '1999', 'webdesk_logo.jpg'),
(32, 34, '23:34', 4545, '12:00am - 1:00am(nursery)', '1-12', '1920', 'webdesk_logo.jpg'),
(33, 35, '23:34', 4545, '12:00am - 12:30am(nursery)', '1-12', '1920', 'webdesk_logo.jpg'),
(39, 41, '23:344433', 454, '12:30am - 12:30am(montessory)', '1-4', '4243', 'webdesk_logo.jpg'),
(40, 42, ':', 0, '12:00am - 12:30am(nursery) , 1:30am - 2:30am(montesory)', '1-12', '', 'webdesk_logo.jpg'),
(0, 43, '', 243, '12:00am - 12:30am(nursery)', '1-10', '', 'webdesk_logo.jpg'),
(41, 44, '', 243, '12:00am - 12:00am(nursery)', '1-10', '', 'webdesk_logo.jpg'),
(42, 45, '', 3233, '2:00am - 2:00am(nursery)', '1-10', '', 'webdesk_logo.jpg');
...
(40, 'St. Xavier\'s School', 'kolkata', 'abc@gmail.com', 3, 1, 'https://www.google.co.in', '9988776655', '1', 0, 0),
(41, 'St. Xavier\'s School', 'kolkata', 's@gmail.com', 3, 1, 'http://www.formvalidator.net', '567465746', '2', 0, 0),
(42, 'Nursery School', 'taratala@123', 'abc@gmail.com', 3, 1, 'https://www.google.co.in', '6666666454', '2, 3, 4', 0, 0);
...
INSERT INTO `user` (`user_id`, `user_email`, `user_phone_no`, `user_password`, `type`, `active`) VALUES
(1, 'admin@gmail.com', '5555555555', '123', 1, 1),
(2, 'user@gmail.com', '6666666666', '234', 0, 1);
...
--
ALTER TABLE `tbl_school`
  MODIFY `school_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=46;
--
-- AUTO_INCREMENT for table `tbl_school_master`
--
ALTER TABLE `tbl_school_master`
  MODIFY `school_master_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
--
-- AUTO_INCREMENT for table `tbl_trasport`
--
ALTER TABLE `tbl_trasport`
  MODIFY `transport_id` int(50) NOT NULL AUTO_INCREMENT;
--
